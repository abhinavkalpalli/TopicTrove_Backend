...
router.post(
  "/createTopic",
  protect,
  UserController.createTopic.bind(UserController)
);
router.get(
...
router.patch(
  "/editTopic",
  protect,
  UserController.editTopic.bind(UserController)
);
router.get(
  "/getAllPreferences",
  UserController.getAllPreferences.bind(UserController)
);
router.post(
  "/createPost",
  protect,
...
router.patch(
  "/dislikePost",
  protect,
  UserController.dislikePost.bind(UserController)
);
router.patch(
  "/blockPost",
  protect,
  UserController.blockPost.bind(UserController)
);
router.get(
  "/:postId/deletePost",
  protect,
